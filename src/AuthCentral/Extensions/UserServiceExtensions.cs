...
namespace Fsw.Enterprise.AuthCentral.Extensions
{
    ...
    {
        public static void ConfigureCustomUserService(this IdentityServerServiceFactory factory, IApplicationBuilder app, string connString, IApplicationEnvironment appEnv)
        {
            factory.Register(new Registration<UserAccount, HierarchicalUserAccount>());
            factory.Register(new Registration<MembershipRebootConfiguration<HierarchicalUserAccount>>(x => MembershipRebootSetup.GetConfig(app, appEnv)));
